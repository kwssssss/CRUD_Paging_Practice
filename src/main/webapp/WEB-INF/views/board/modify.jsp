	...
	<div class="panel-body">
		<form role="form" method="post">
			...
			<div class="form-group">
				<label>Title</label> <input name="title" class="form-control" value="${board.title}"
					required>
			</div>
			<div class="form-group">
				<label>Writer</label> <input name="writer" class="form-control" value="${board.writer}"
					required>
			</div>
			<div class="form-group">
				<label>Content</label>
			...
			<a href="get?bno=${board.bno}" class="btn btn-primary"> <i class="fas fa-list"></i>돌아가기
			</a>
		</form>
	</div>
</div>
